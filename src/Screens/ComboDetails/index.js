...
class ComboDetails extends Component {
  ...
  getComboDetailsById = async () => {
    try {
      const data = {
        ...
        latitude: this.props.redux.auth.position.isLocation
          ? this.props.redux.auth.position.latitude
          : '',
        longitude: this.props.redux.auth.position.isLocation
          ? this.props.redux.auth.position.longitude
          : '',
      };
      const res = await fetchComboDetailsById(data);
      this.setState({
        data: res.response.result.comboDatas,
        hostUrl: res.response.result.hostUrl,
      });
  ...
  render() {
    // var des = <p>This&nbsp;product represents vouchers, each redeemable for 30ml of Chivas Regal 12Y Whiskey.</p>
            ...
            <ScrollView>
              <View style={styles.container}>
                <View>
                  <ImageBackground
                    ...
                    resizeMode={'cover'}
                    source={{
                      uri: this.state.hostUrl + this.state.data.images,
                    }}
                ...
                <View style={styles.cardContainer}>
                  <View style={styles.cardHeader}>
                    ...
                    <View
                      ...
                      <HTMLView value={this.state.data.shortDescription} />
                    </View>
                    ...
                    <View>
                      <View style={styles.quantity}>
                        <Text style={styles.qtyText}>
                          {this.state.data.comboQty +
                            this.state.data.comboQtyType}
                        </Text>
                      </View>
                    </View>
                    ...
                    <View style={styles.cartBtnContainer}>
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          ...
                          this.state.data.ecom_ba_wishlist.wishlistId
                            ? this.removeFavorite(
                                this.state.data.ecom_ba_wishlist.wishlistId,
                              )
              ...
              <View style={styles.redeem}>
                <View style={styles.redeemContainer}>
                  <Text style={styles.redeemHeader}>Redeemable in Bars</Text>
